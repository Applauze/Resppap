...
export async function POST(request, response) {
  ...
  const update_sql = `Update students_details SET surname = ?, firstname = ?, middlename = ?, dob = ?,  sex = ?, session_admitted = ?, term_admitted = ?, class_admitted = ? , picture_directory = ? WHERE student_id = ?`;
